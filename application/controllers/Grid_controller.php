	...
	public function byTwos() {
		...
		$this->loadContainer( function() {
			...
			$this->loadRow( function() {
				...
				$this->loadCol( function() {
					$this->loadGridRow( function() {
						$sampleData['gridTitle'] = "Grid, by-twos";
						$sampleData['gridCount'] = "by-twos";
						$sampleData['grid'] = array(
							array('image'=>"https://images.pexels.com/photos/428320/pexels-photo-428320.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260",
								'title'=>"Sample One",
								'desc'=>"Lorem ipsum dolor sit amet",
				...
				$this->loadCol( function() {
					$this->loadGridRow( function() {
						$sampleData['gridTitle'] = "Grid, by-twos, No Description";
						$sampleData['gridCount'] = "by-twos";
						$sampleData['grid'] = array(
							array('image'=>"https://images.pexels.com/photos/428320/pexels-photo-428320.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260",
								'title'=>"Sample One",
				...
				$this->loadCol( function() {
					$this->loadGridRow( function() {
						$sampleData['gridTitle'] = "Grid, by-twos, Image Only";
						$sampleData['gridCount'] = "by-twos";
						$sampleData['grid'] = array(
							array('image'=>"https://images.pexels.com/photos/428320/pexels-photo-428320.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260",
								'title'=>"",
